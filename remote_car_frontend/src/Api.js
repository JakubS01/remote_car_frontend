...
class Api {
    ...
    async StartCarAdmin(id) {
        try {
            const response = await fetch(Api.Url + `/car_admin/start/${id}`, {
                method: "POST",
                headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
    ...
    async ForceStopCarAdmin(id) {
        try {
            const response = await fetch(Api.Url + `/car_admin/force_stop/${id}`, {
                method: "POST",
                headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
    ...
    async RentCar(id) {
        try {
            const response = await fetch(Api.Url + `/car/rent/${id}`, {
                method: "POST",
                headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
    ...
    async TakeSteeringCar(id, session) {
        try {
            const response = await fetch(Api.Url + `/car/take_control/${id}`, {
                method: "POST",
                headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
